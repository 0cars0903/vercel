            ...
            <div class="upload-section" id="uploadSection">
                ...
                <div class="upload-area" id="uploadArea">
                    <div>
                        ...
                        <p style="color: #666;">JPG, PNG 파일을 지원합니다 (최대 16MB)</p>
                    </div>
                </div>
                ...
                <div class="processing-fast" id="speedInfo" style="display: none;">
                    ⚡ 빠른 처리: 평균 5초 이내 완료!
                </div>
            </div>
        ...
        async function processFile(file) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    showSuccess('처리 완료! 빠른 속도로 정보를 추출했습니다.');
                } else {
